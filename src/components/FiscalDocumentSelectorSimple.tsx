...
// ============================================
// SELECTOR FISCAL SIMPLIFICADO (SIN RPC)
// ============================================
...
const FiscalDocumentSelectorSimple: React.FC<FiscalDocumentSelectorProps> = ({
  value = {},
  onChange,
  clientData,
  errors = {}
...
export default FiscalDocumentSelectorSimple