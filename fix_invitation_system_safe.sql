...
-- VERSIÓN SEGURA - MANEJA FUNCIONES EXISTENTES
-- =====================================================
...
-- 3. CREAR TABLA DE MIEMBROS DE ORGANIZACIÓN
...
-- 6. CREAR FUNCIÓN PARA GENERAR TOKENS SEGUROS
...
-- 9. FUNCIÓN: OBTENER INVITACIÓN POR TOKEN
...
-- 12. CREAR TRIGGERS PARA ACTUALIZAR timestamps
...
-- 14. CREAR ORGANIZACIÓN POR DEFECTO Y ASIGNAR USUARIOS EXISTENTES
...
-- 15. AGREGAR COLUMNA organization_id A TABLAS EXISTENTES
...
-- 16. ACTUALIZAR REGISTROS EXISTENTES CON organization_id
DO $$
DECLARE
    org_id UUID;
BEGIN
...
-- 17. CREAR FUNCIÓN PARA OBTENER ORGANIZACIÓN ACTUAL DEL USUARIO
...
SELECT 
    'INFORMACIÓN ÚTIL' as section,
    'Las siguientes funciones RPC están ahora disponibles:' as descripcion;

SELECT 
    'create_organization_invitation(org_id, email, role)' as funcion,
    'Crear una nueva invitación' as descripcion
UNION ALL
SELECT 
    'accept_organization_invitation(token)' as funcion,
    'Aceptar una invitación' as descripcion
UNION ALL
SELECT 
    'get_invitation_by_token(token)' as funcion,
    'Obtener detalles de una invitación' as descripcion
UNION ALL
SELECT 
    'cancel_organization_invitation(invitation_id)' as funcion,
    'Cancelar una invitación' as descripcion
UNION ALL
SELECT 
    'cleanup_expired_invitations()' as funcion,
    'Limpiar invitaciones expiradas' as descripcion;