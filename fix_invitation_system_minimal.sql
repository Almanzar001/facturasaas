-- =====================================================
-- SISTEMA DE INVITACIONES - VERSIÓN MÍNIMA Y SEGURA
-- =====================================================
...
-- 2. VERIFICAR Y CREAR TABLA DE ORGANIZACIONES
DO $$
BEGIN
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        IF NOT EXISTS (SELECT 1 FROM organization_members WHERE organization_id = org_id AND user_id = current_user_id) THEN
...
-- 13. CREAR ORGANIZACIÓN POR DEFECTO SI NO EXISTE
DO $$
DECLARE
    org_id UUID;
    user_record RECORD;
BEGIN
    ...
    -- Asignar todos los usuarios existentes a la organización como owners
...
-- Políticas básicas y permisivas
CREATE POLICY "Users can view organizations they belong to" ON organizations
    FOR SELECT USING (true); -- Permisivo inicialmente
...
-- Mostrar resumen
SELECT 
    'INSTALACIÓN MÍNIMA COMPLETADA' as status,
