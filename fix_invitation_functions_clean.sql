-- =====================================================
-- LIMPIAR Y RECREAR FUNCIONES DE INVITACIÓN
-- =====================================================

-- 1. ELIMINAR TODAS LAS VERSIONES CONFLICTIVAS DE LAS FUNCIONES
...
-- 2. CREAR FUNCIÓN PARA GENERAR TOKENS SEGUROS
...
-- 3. FUNCIÓN: CREAR INVITACIÓN (VERSIÓN ÚNICA)
...
-- 4. FUNCIÓN: ACEPTAR INVITACIÓN (VERSIÓN ÚNICA)
...
-- 5. FUNCIÓN: OBTENER INVITACIÓN POR TOKEN (VERSIÓN ÚNICA)
...
-- 6. FUNCIÓN: CANCELAR INVITACIÓN (VERSIÓN ÚNICA)
...
-- 7. FUNCIÓN: LIMPIAR INVITACIONES EXPIRADAS (VERSIÓN ÚNICA)
...
-- 8. VERIFICAR QUE LAS FUNCIONES ESTÁN DISPONIBLES
SELECT 
    'FUNCIONES RECREADAS EXITOSAMENTE' as status,
    COUNT(*) as total_funciones
FROM information_schema.routines 
WHERE routine_name LIKE '%invitation%' 
AND routine_type = 'FUNCTION';

-- 9. MOSTRAR FUNCIONES DISPONIBLES
SELECT 
